...
public class ScoreServiceV1 {
	...
	public void init() {
		...
		// Scanner와 Random 을 선언과 분리하여 생성하는 코드를 작성함
		scan = new Scanner(System.in);
		rnd = new Random();

		System.out.print("처리할 학생의 숫자 >> ");
	...
	/* Test를 위한 학생 데이터 생성 및 배열과 객체 초기화
	 * 테스트를 위해 학생 이름 리스트를 미리 배열로 만들고
	 * 학생 이름수 만큼 성적, 총점, 평균 배열 생성, 랜덤 클래스 초기화하여 사용 준비
	 */
	public void makeNamesAndArrayInit() {

		// rnd.nextInt() method를 호출하기 전에 실행되어야 한다
		rnd = new Random();
		strName = new String[] { "홍길동", "이몽룡", "성춘향", "장록수",
							     "임꺽정", "김태연", "설운도", "장윤정" };
