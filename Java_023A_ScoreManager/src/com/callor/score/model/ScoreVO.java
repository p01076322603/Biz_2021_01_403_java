...
/* 성적 처리를 위한 기본 데이터를 저장할 Value Object 클래스
 * DTO(Data Transfer Object), DD(Data Define)등으로 불린다
...
public class ScoreVO {
	...
	// 변수 작명 ──> 변수 타입 결정 ──> 정보은닉 설정(private)
	...
	/* 필드생성자 정의 ──> 객체를 생성할 때 변수값을 지정하면서 만든다
	...
	// private으로 선언된 인스턴스 변수에 접근할 getter, setter 생성
	 ...
	 * VO객체에 데이터를 저장한 후 값을 확인하기 위한 Debugging용 method 재 정의 */
